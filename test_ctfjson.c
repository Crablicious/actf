...
static void test_ctfjson_extensions(void)
{
	...
	CU_ASSERT_FATAL(actf_fld_struct_len(mytracer) == 2);
	{
		...
		CU_ASSERT_STRING_EQUAL(actf_fld_struct_fld_name_idx(piano, 0), "keys");
		...
		CU_ASSERT_STRING_EQUAL(actf_fld_struct_fld_name_idx(piano, 1), "temperament");
	...
	CU_ASSERT_FATAL(actf_fld_struct_len(abcxyz) == 1);
	{
		...
		CU_ASSERT_STRING_EQUAL(actf_fld_struct_fld_name_idx(sax, 0), "variant");
...
static void test_ctfjson_attributes(void)
{
	...
	CU_ASSERT_FATAL(actf_fld_struct_len(mytracer) == 2);
	{
	    ...
	    CU_ASSERT_STRING_EQUAL(actf_fld_struct_fld_name_idx(mytracer, 0), "max-count");
