...
const char *null_term_str_extensions_path = "testdata/test_ctf_fld_cls_null_term_str_extensions.json";
...
static void test_fld_cls_variant_attributes(void)
{
    ...
    const uint64_t expected_uuid[] = {243, 97, 0, 184, 236, 54, 72, 97, 141, 107, 169, 214, 171, 137, 115, 201};
